        ...
        >
          ...
          <div className="space-y-4">
            ...
            {stats?.recentTransactions?.map((tx, idx) => (
              <div key={tx._id || idx} className="flex items-center justify-between p-3 bg-warning/20 border border-warning/40 rounded-xl transition-all duration-300 hover:bg-warning/30 hover:-translate-y-[2px] hover:shadow-md">
